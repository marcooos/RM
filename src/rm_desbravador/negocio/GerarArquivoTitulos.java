...
public class GerarArquivoTitulos {
    ...
    public boolean gerarArquivoTitulos(Date data, String caminho, boolean tipoBanco) {
        ...
        GerarLinhaTitulosU gerarLinhaTitulosU = new GerarLinhaTitulosU();
        ...
        try {
            ...
            ResultSet rsTitulos = titulosDao.listaDeTitulos(tipoBanco, data);//calendarData.getTime());
            ...
            while (rsTitulos.next()) {
                ...
                //2
                mensagem = mensagem + gerarLinhaTitulosU.gerarLinhaTitulosU(rsTitulos) + "\n";
                //3
