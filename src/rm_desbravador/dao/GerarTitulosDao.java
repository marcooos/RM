    ...
    public ResultSet listaDeTitulos(boolean tipoBanco, Date data) {
        ...
        if (tipoBanco) {
            ...
            sql = "Select codrazao,ce.cgc, ce.codempresa as clifor,"
                    ...
                    + "  then ce.cgc"
                    + "  else coalesce((select top 1 cgc from cadempresa where ad.titular = nomeempresa),'000000000000')"
                    + "  end cgc," 
                    + " case when ad.codcartao is not null"
                    + "  then ce.codempresa"
                    + "  else coalesce((select top 1 codempresa from cadempresa where ad.titular = nomeempresa),0)"
                    + "  end codempresa,"
